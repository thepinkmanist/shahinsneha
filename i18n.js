...
const translations = {
  en: {
    ...
    findFacesBody: "Upload one or more clear, front-facing selfies. Everything runs on this device — nothing is uploaded anywhere.",
    addAnotherSelfie: "Add another selfie",
